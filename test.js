function(t, e, n, o, r) {
    ...
    function C(t, e) {
        at.playSound("playerJoin"), it = io(t, {
            ...
            it.on("disconnect", function() {
                ...
                n.id != st.drawingID && !n.guessedWord && o || st.chatAddMsg(e, v(t.message), o ? "#7dad3f" : "#000")
    ...
    function T(t, e, n) {
        if (st.checkDrawing() && (ut.updateMousePosition(t, e, n), ut.brush.down)) {
            var o = null;
    ...
    function I(t) {
        st.drawingID == st.myID ? (ut.drawCommands.push(t), ut.performDrawCommand(t)) : ut.addDrawCommandReceived(t)
    }
    ...
    tt.prototype.updatePlayerAvatars = function() {
        ...
        n("#boxMessages").empty()
    }, tt.prototype.chatAddMsg = function(t, e, o) {
        var r = n("#boxMessages"),
    ...
    S(80), n("#lobbySetLanguage").on("change", function() {
        ...
        st && st.checkDrawing() && T(t.clientX, t.clientY, !1)
    }), n(e).keypress(function(t) {
        if (st && st.checkDrawing() && t !== r && t.key !== r) switch (t.key.toUpperCase()) {
            case "B":
